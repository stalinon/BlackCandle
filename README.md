Отлично, вот теперь мы подходим к той самой **вики-бомбе**, которую можно красиво и понятно вставить в `README.md`, чтобы каждый (даже ты через полгода) понял, **что делает проект**, **что он должен уметь** и **по каким правилам живёт**.
